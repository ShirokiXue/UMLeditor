...
import src.CanvasObject.LineObject.AssociationLine;

public class CreateAssociationFunc extends MouseInputAdapter {
    ...
    public CreateAssociationFunc(MainFrame f) {
        // this.frame = f;
