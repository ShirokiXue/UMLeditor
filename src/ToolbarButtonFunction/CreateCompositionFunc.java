...
import src.CanvasObject.LineObject.CompositionLine;

public class CreateCompositionFunc extends MouseInputAdapter {
    ...
    public CreateCompositionFunc(MainFrame f) {
        // this.frame = f;
